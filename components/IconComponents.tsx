...
export const TikTokIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
    <svg fill="currentColor" viewBox="0 0 24 24" className={className}>
        <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-2.5.04-4.84-1.13-6.49-3.03-1.65-1.9-2.32-4.35-2.16-6.84.17-2.43 1.25-4.66 2.89-6.35 1.73-1.78 4.02-2.75 6.35-2.71.02 1.54-.01 3.08.01 4.63-.98.01-1.96 0-2.95-.02-1.28-.03-2.56.24-3.69.89-1.12.65-2.02 1.62-2.58 2.8-.42.88-.63 1.86-.64 2.83.02 1.48.63 2.91 1.59 4.07 1.07 1.27 2.58 2.05 4.23 2.05 1.78 0 3.34-.85 4.28-2.14.94-1.29 1.28-2.88 1.21-4.51.04-2.88.02-5.76.01-8.64-.01-1.57.59-3.11 1.68-4.16.03-.03.07-.06.1-.09-.03 1.54.02 3.08-.01 4.62z"/>
    </svg>
);
...
export const TruckIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 01-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h1.125c.621 0 1.125-.504 1.125-1.125V14.25m-17.25 4.5v-1.875a3.375 3.375 0 013.375-3.375h9.75a3.375 3.375 0 013.375 3.375v1.875m-17.25 4.5h15M6.375 6.375h11.25L21 12.75H3l3.375-6.375z" />
    </svg>
);
...
export const SwatchIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M4.098 19.902a3.75 3.75 0 005.304 0l6.401-6.402a3.75 3.75 0 00-.615-5.898L8.384 4.242a3.75 3.75 0 00-5.898-.615l-2.4 2.4a3.75 3.75 0 000 5.304l4.098 4.098zM19.902 4.098a3.75 3.75 0 00-5.304 0l-1.5 1.5a3.75 3.75 0 005.304 5.304l1.5-1.5a3.75 3.75 0 000-5.304z" />
    </svg>
);
...
export const ShoppingCartIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 0 0-3 3h15.75m-12.75-3h11.218c.51 0 .962-.343 1.087-.835l1.838-5.513a1.125 1.125 0 0 0-1.087-1.413H4.875M16.5 21a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Zm-9 0a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Z" />
    </svg>
);
